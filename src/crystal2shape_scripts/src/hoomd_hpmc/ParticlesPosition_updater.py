...
class ParticlesPositionAction(hoomd.custom.Action):
    """
    Custom action to update particle positions based on the current box vectors.
    ...
    wall_potential : hoomd.hpmc.external.wall.WallPotential
        The wall potential to be updated. This should be an instance of
        `hoomd.hpmc.external.wall.WallPotential` that contains the walls to
        be adjusted based on the current box vectors.
